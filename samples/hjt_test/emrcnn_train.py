...
class SignatureConfig(Config):
    """Configuration for training on the toy signature dataset.
    ...
    NUM_CLASSES = 1 + 1  # background + myClass signature
...
class SignatureDataset(utils.Dataset):
    """Generates the signature synthetic dataset. The dataset consists of simple
    signature (triangles, squares, circles) placed randomly on a blank surface.
    ...
    def load_signature(self,count, img_floder, imglist):
        ...
        # list of signature sizes and locations). This is more compact than
